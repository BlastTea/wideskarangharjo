...
<div>
    <form wire:submit="register">
        ...
        <div>
            ...
            <x-elements.text-input wire:model="name" id="name" class="block mt-1 w-full" type="text" name="name" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-elements.text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" required autocomplete="username" />
